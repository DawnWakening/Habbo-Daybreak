...
import com.eu.habbo.messages.incoming.friends.HabboSearchMessageEvent;
import com.eu.habbo.messages.incoming.navigator.RoomTextSearchMessageEvent;
...
public class CleanerThread implements Runnable {
    ...
    public void run() {
        ...
        RoomTextSearchMessageEvent.cachedResults.clear();
        HabboSearchMessageEvent.cachedResults.clear();
    }
    ...
    public void refillDailyRespects() {
        ...
        if (Emulator.isReady) {
            for (Habbo habbo : Emulator.getGameEnvironment().getHabboManager().getOnlineHabbos().values()) {
                ...
                habbo.getClient().sendResponse(new UserObjectMessageComposer(habbo));
            }
        }
    }
