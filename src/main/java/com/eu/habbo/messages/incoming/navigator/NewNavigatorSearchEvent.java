...
public class NewNavigatorSearchEvent extends MessageHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(NewNavigatorSearchEvent.class);
    ...
    public void handle() throws Exception {
        ...
        if (filter == null) {
            ...
            if (rooms != null) {
                ...
                this.client.sendResponse(new NavigatorSearchResultBlocksMessageComposer(view, query, resultLists));
                return;
            }
        }
