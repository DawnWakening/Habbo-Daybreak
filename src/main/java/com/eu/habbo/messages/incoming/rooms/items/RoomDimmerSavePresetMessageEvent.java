...
public class RoomDimmerSavePresetMessageEvent extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        this.client.sendResponse(new RoomDimmerPresetsMessageComposer(room.getMoodlightData()));
    }
}
