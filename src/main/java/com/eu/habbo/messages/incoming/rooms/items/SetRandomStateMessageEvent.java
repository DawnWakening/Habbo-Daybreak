...
public class SetRandomStateMessageEvent extends MessageHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(SetRandomStateMessageEvent.class);
