...
import com.eu.habbo.messages.outgoing.handshake.CompleteDiffieHandshakeMessageComposer;
...
public class CompleteDiffieHandshakeEvent extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        this.client.sendResponse(new CompleteDiffieHandshakeMessageComposer(this.client.getEncryption().getDiffie().getPublicKey()));
