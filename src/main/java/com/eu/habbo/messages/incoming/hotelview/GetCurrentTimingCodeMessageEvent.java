...
public class GetCurrentTimingCodeMessageEvent extends MessageHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(GetCurrentTimingCodeMessageEvent.class);
