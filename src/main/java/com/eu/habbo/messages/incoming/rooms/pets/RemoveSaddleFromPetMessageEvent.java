...
public class RemoveSaddleFromPetMessageEvent extends MessageHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(RemoveSaddleFromPetMessageEvent.class);
    ...
    public void handle() throws Exception {
        ...
        this.client.sendResponse(new UnseenItemsMessageComposer(saddle));
