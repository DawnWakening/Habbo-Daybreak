...
public class AddSpamWallPostItMessageEvent extends MessageHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(AddSpamWallPostItMessageEvent.class);
