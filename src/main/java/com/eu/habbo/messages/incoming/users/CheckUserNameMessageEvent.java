...
public class CheckUserNameMessageEvent extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        } else if (name.equalsIgnoreCase(this.client.getHabbo().getHabboInfo().getUsername()) || HabboManager.getOfflineHabboInfo(name) != null || ChangeUserNameMessageEvent.changingUsernames.contains(name.toLowerCase())) {
