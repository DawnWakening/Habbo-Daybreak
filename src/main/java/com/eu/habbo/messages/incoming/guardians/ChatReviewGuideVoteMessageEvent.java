...
public class ChatReviewGuideVoteMessageEvent extends MessageHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(ChatReviewGuideVoteMessageEvent.class);
