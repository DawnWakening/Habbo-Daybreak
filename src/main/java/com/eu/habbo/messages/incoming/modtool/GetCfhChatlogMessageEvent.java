...
import com.eu.habbo.messages.outgoing.modtool.CfhChatlogMessageComposer;

import java.util.ArrayList;
import java.util.List;
import java.util.stream.Collectors;

public class GetCfhChatlogMessageEvent extends MessageHandler {
    @Override
    public void handle() throws Exception {
        if (this.client.getHabbo().hasPermission(Permission.ACC_SUPPORTTOOL)) {
            ...
            if (issue != null) {
                ...
                this.client.sendResponse(new CfhChatlogMessageComposer(issue, chatlog, roomName, chatlogType));
            }
        } else {
