...
public class CallForHelpFromPhotoMessageEvent extends MessageHandler {
    @Override
    public void handle() throws Exception {
        ...
        if (hasExtradataId) {
            this.packet.readString(); // extradataId - not used
        }

        int roomId = this.packet.readInt();
        this.packet.readInt(); // reportedUserId - not used
