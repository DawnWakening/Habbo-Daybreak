...
public class ChangeUserNameMessageEvent extends MessageHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(ChangeUserNameMessageEvent.class);
