...
import com.eu.habbo.messages.outgoing.users.FigureSetIdsMessageComposer;
...
public class CustomizeAvatarWithFurniMessageEvent extends MessageHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(CustomizeAvatarWithFurniMessageEvent.class);
                ...
                if (item instanceof InteractionClothing) {
                    ...
                    if (clothing != null) {
                        if (!this.client.getHabbo().getInventory().getWardrobeComponent().getClothing().contains(clothing.id)) {
                            ...
                            this.client.getHabbo().getHabboInfo().getCurrentRoom().sendComposer(new ObjectRemoveMessageComposer(item, true).compose());
                            ...
                            this.client.sendResponse(new FigureSetIdsMessageComposer(this.client.getHabbo()));
