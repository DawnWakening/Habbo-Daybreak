...
import com.eu.habbo.messages.outgoing.rooms.promotions.RoomAdPurchaseInfoMessageComposer;
...
public class GetRoomAdPurchaseInfoEvent extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        this.client.sendResponse(new RoomAdPurchaseInfoMessageComposer(roomsToShow));
    }
}
