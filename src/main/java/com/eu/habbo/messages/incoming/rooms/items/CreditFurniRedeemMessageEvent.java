...
public class CreditFurniRedeemMessageEvent extends MessageHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(CreditFurniRedeemMessageEvent.class);
