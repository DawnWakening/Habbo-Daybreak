...
public class ForwardToSomeRoomMessageEvent extends MessageHandler {
    @Override
    public void handle() throws Exception {
        ...
        if (data.equals("random_friending_room")) {
            ...
            this.client.sendResponse(new NavigatorSettingsMessageComposer(this.client.getHabbo().getHabboInfo().getHomeRoom(), this.client.getHabbo().getHabboInfo().getHomeRoom()));
        }
    }
}
