...
public class ClubGiftInfoMessageComposer extends MessageComposer {

    private final int daysTillNextGift;
    private final int availableGifts;
    private final int daysAsHc;

    public ClubGiftInfoMessageComposer(int daysTillNextGift, int availableGifts, int daysAsHc) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.ClubGiftInfoMessageComposer);
