...
public class TradingItemListMessageComposer extends MessageComposer {
    private final RoomTrade roomTrade;

    public TradingItemListMessageComposer(RoomTrade roomTrade) {
        this.roomTrade = roomTrade;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.TradingItemListMessageComposer);
