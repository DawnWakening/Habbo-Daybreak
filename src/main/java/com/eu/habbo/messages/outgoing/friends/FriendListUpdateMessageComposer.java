...
public class FriendListUpdateMessageComposer extends MessageComposer {
    private Collection<MessengerBuddy> buddies;

    private Habbo habbo;
    private int action;

    public FriendListUpdateMessageComposer(Habbo habbo, MessengerBuddy buddy, Integer action) {
        this.habbo = habbo;
        this.buddies = Collections.singletonList(buddy);
        this.action = action;
    }

    public FriendListUpdateMessageComposer(Habbo habbo, Collection<MessengerBuddy> buddies, Integer action) {
        this.habbo = habbo;
    ...
    protected ServerMessage composeInternal() {
        ...
        this.response.init(Outgoing.FriendListUpdateMessageComposer);
