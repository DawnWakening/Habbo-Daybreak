...
public class RoomChatlogMessageComposer extends MessageComposer {
    private final Room room;
    private final ArrayList<ModToolChatLog> chatlog;

    public RoomChatlogMessageComposer(Room room, ArrayList<ModToolChatLog> chatlog) {
        this.room = room;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.RoomChatlogMessageComposer);
