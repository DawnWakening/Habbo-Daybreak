...
public class InitDiffieHandshakeMessageComposer extends MessageComposer {

    private final String signedPrime;
    private final String signedGenerator;

    public InitDiffieHandshakeMessageComposer(String signedPrime, String signedGenerator) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.InitDiffieHandshakeMessageComposer);
