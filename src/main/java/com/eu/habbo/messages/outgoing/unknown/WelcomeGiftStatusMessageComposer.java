...
public class WelcomeGiftStatusMessageComposer extends MessageComposer {
    ...
    public WelcomeGiftStatusMessageComposer(String email, boolean unknownB1, boolean unknownB2, int furniId, boolean unknownB3) {
        this.email = email;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.WelcomeGiftStatusMessageComposer);
