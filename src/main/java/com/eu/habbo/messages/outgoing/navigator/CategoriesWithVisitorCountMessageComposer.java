...
public class CategoriesWithVisitorCountMessageComposer extends MessageComposer {
    public final List<RoomCategory> roomCategories;

    public CategoriesWithVisitorCountMessageComposer(List<RoomCategory> roomCategories) {
        this.roomCategories = roomCategories;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.CategoriesWithVisitorCountMessageComposer);
