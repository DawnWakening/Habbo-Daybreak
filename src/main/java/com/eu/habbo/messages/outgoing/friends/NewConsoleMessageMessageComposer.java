...
public class NewConsoleMessageMessageComposer extends MessageComposer {
    private final Message message;
    private final int toId;
    private final int fromId;

    public NewConsoleMessageMessageComposer(Message message) {
        this.message = message;
        this.toId = message.getFromId();
        this.fromId = message.getFromId();
    }

    public NewConsoleMessageMessageComposer(Message message, int toId, int fromId) {
        this.message = message;
        this.toId = toId;
        this.fromId = fromId;
    }
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.NewConsoleMessageMessageComposer);
