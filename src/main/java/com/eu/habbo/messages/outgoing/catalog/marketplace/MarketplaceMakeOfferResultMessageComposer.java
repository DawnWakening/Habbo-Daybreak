...
public class MarketplaceMakeOfferResultMessageComposer extends MessageComposer {
    ...
    public MarketplaceMakeOfferResultMessageComposer(int code) {
        this.code = code;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.MarketplaceMakeOfferResultMessageComposer);
