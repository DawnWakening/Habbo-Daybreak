...
public class ModeratorRoomInfoMessageComposer extends MessageComposer {
    private final Room room;

    public ModeratorRoomInfoMessageComposer(Room room) {
        this.room = room;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.ModeratorRoomInfoMessageComposer);
