...
public class TradingOpenFailedMessageComposer extends MessageComposer {
    ...
    public TradingOpenFailedMessageComposer(int code) {
        this.code = code;
        this.username = "";
    }

    public TradingOpenFailedMessageComposer(int code, String username) {
        this.code = code;
        this.username = username;
    }

    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.TradingOpenFailedMessageComposer);
