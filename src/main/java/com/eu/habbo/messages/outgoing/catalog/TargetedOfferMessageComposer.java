...
public class TargetedOfferMessageComposer extends MessageComposer {
    private final Habbo habbo;
    private final TargetOffer offer;

    public TargetedOfferMessageComposer(Habbo habbo, TargetOffer offer) {
        this.habbo = habbo;
        this.offer = offer;
    }
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.TargetedOfferMessageComposer);
