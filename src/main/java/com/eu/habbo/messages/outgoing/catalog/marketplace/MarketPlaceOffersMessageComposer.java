...
public class MarketPlaceOffersMessageComposer extends MessageComposer {
    private final List<MarketPlaceOffer> offers;

    public MarketPlaceOffersMessageComposer(List<MarketPlaceOffer> offers) {
        this.offers = offers;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.MarketPlaceOffersMessageComposer);
