...
public class ScrSendUserInfoMessageComposer extends MessageComposer {
    ...
    public ScrSendUserInfoMessageComposer(Habbo habbo) {
        this.habbo = habbo;
        this.subscriptionType = SubscriptionHabboClub.HABBO_CLUB.toLowerCase();
        this.responseType = 0;
    }

    public ScrSendUserInfoMessageComposer(Habbo habbo, String subscriptionType) {
        this.habbo = habbo;
        this.subscriptionType = subscriptionType;
        this.responseType = 0;
    }

    public ScrSendUserInfoMessageComposer(Habbo habbo, String subscriptionType, int responseType) {
        this.habbo = habbo;
        this.subscriptionType = subscriptionType;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.ScrSendUserInfoMessageComposer);
