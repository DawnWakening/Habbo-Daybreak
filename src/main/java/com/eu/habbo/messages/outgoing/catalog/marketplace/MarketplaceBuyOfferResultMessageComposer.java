...
public class MarketplaceBuyOfferResultMessageComposer extends MessageComposer {
    ...
    public MarketplaceBuyOfferResultMessageComposer(int errorCode, int unknown, int offerId, int price) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.MarketplaceBuyOfferResultMessageComposer);
