...
public class QuestionMessageComposer extends MessageComposer {
    public final int duration;
    public final String question;

    public QuestionMessageComposer(int duration, String question) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.QuestionMessageComposer);
