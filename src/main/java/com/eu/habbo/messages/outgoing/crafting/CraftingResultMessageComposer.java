...
public class CraftingResultMessageComposer extends MessageComposer {
    private final CraftingRecipe recipe;
    private final boolean succes;

    public CraftingResultMessageComposer(CraftingRecipe recipe) {
        this.recipe = recipe;
        this.succes = this.recipe != null;
    }

    public CraftingResultMessageComposer(CraftingRecipe recipe, boolean success) {
        this.recipe = recipe;
        this.succes = success;
    }
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.CraftingResultMessageComposer);
