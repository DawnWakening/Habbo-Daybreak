...
public class PetLevelNotificationMessageComposer extends MessageComposer {
    private final Pet pet;

    public PetLevelNotificationMessageComposer(Pet pet) {
        this.pet = pet;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.PetLevelNotificationMessageComposer);
