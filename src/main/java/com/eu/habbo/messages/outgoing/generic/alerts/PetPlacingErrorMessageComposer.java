...
public class PetPlacingErrorMessageComposer extends MessageComposer {
    ...
    public PetPlacingErrorMessageComposer(int errorCode) {
        this.errorCode = errorCode;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.PetPlacingErrorMessageComposer);
