...
public class CraftableProductsMessageComposer extends MessageComposer {
    ...
    public CraftableProductsMessageComposer(List<CraftingRecipe> recipes, Collection<Item> ingredients) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.CraftableProductsMessageComposer);
