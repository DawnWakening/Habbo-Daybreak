...
public class TradingOpenMessageComposer extends MessageComposer {
    private final RoomTrade roomTrade;
    private final int state;

    public TradingOpenMessageComposer(RoomTrade roomTrade) {
        this.roomTrade = roomTrade;
        this.state = 1;
    }

    public TradingOpenMessageComposer(RoomTrade roomTrade, int state) {
        this.roomTrade = roomTrade;
        this.state = state;
    }
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.TradingOpenMessageComposer);
