...
public class LoadGameMessageMessageComposer extends MessageComposer {
    public static String FASTFOOD_KEY = "";

    private final GameClient client;
    private final int game;

    public LoadGameMessageMessageComposer(GameClient client, int game) {
        this.client = client;
        this.game = game;
    }
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.LoadGameMessageMessageComposer);
