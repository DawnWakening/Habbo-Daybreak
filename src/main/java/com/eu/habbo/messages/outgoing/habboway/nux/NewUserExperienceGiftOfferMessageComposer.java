...
public class NewUserExperienceGiftOfferMessageComposer extends MessageComposer {
    private final List<List<NewUserGift>> options;

    public NewUserExperienceGiftOfferMessageComposer(List<List<NewUserGift>> options) {
        this.options = options;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.NewUserExperienceGiftOfferMessageComposer);
