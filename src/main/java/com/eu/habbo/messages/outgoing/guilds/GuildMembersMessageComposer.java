...
public class GuildMembersMessageComposer extends MessageComposer {
    ...
    public GuildMembersMessageComposer(Guild guild, ArrayList<GuildMember> members, Habbo session, int pageId, int level, String searchValue, boolean isAdmin, int totalCount) {
        this.guild = guild;
