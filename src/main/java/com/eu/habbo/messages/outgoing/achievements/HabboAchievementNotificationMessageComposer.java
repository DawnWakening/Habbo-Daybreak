...
public class HabboAchievementNotificationMessageComposer extends MessageComposer {
    private final Achievement achievement;
    private final Habbo habbo;

    public HabboAchievementNotificationMessageComposer(Habbo habbo, Achievement achievement) {
