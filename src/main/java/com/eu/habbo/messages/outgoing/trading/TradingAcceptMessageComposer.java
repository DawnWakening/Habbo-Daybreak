...
public class TradingAcceptMessageComposer extends MessageComposer {
    private final RoomTradeUser tradeUser;

    public TradingAcceptMessageComposer(RoomTradeUser tradeUser) {
        this.tradeUser = tradeUser;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.TradingAcceptMessageComposer);
