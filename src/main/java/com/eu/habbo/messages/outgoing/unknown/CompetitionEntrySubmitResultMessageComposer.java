...
public class CompetitionEntrySubmitResultMessageComposer extends MessageComposer {
    ...
    public CompetitionEntrySubmitResultMessageComposer(int unknownInt1, String unknownString1, int result, List<String> unknownStringList1, List<String> unknownStringList2) {
