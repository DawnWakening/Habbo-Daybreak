...
public class PetStatusUpdateMessageComposer extends MessageComposer {
    private final Pet pet;

    public PetStatusUpdateMessageComposer(Pet pet) {
        this.pet = pet;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.PetStatusUpdateMessageComposer);
