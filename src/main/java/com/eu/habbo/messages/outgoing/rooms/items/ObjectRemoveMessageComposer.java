...
public class ObjectRemoveMessageComposer extends MessageComposer {
    private final HabboItem item;
    private final boolean noUser;

    public ObjectRemoveMessageComposer(HabboItem item) {
        this.item = item;
        this.noUser = false;
    }

    public ObjectRemoveMessageComposer(HabboItem item, boolean noUser) {
        this.item = item;
        this.noUser = noUser;
    }
