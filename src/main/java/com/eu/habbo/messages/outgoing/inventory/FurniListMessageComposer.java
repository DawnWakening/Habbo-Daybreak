...
public class FurniListMessageComposer extends MessageComposer implements TIntObjectProcedure<HabboItem> {
    private static final Logger LOGGER = LoggerFactory.getLogger(FurniListMessageComposer.class);

    private final int fragmentNumber;
    private final int totalFragments;
    private final TIntObjectMap<HabboItem> items;

    public FurniListMessageComposer(int fragmentNumber, int totalFragments, TIntObjectMap<HabboItem> items) {
    ...
    protected ServerMessage composeInternal() {
        try {
            this.response.init(Outgoing.FurniListMessageComposer);
