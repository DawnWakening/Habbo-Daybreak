...
public class EmailStatusResultMessageComposer extends MessageComposer {
    private final String email;
    private final boolean unknownB1;
    private final boolean unknownB2;

    public EmailStatusResultMessageComposer(String email, boolean unknownB1, boolean unknownB2) {
        this.email = email;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.EmailStatusResultMessageComposer);
