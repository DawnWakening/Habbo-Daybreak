...
public class UserChatlogMessageComposer extends MessageComposer {
    public static SimpleDateFormat format = new SimpleDateFormat("HH:mm");
    private final ArrayList<ModToolRoomVisit> set;
    private final int userId;
    private final String username;

    public UserChatlogMessageComposer(ArrayList<ModToolRoomVisit> set, int userId, String username) {
        this.set = set;
        this.userId = userId;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.UserChatlogMessageComposer);
