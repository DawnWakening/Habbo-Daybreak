...
public class FlatControllersMessageComposer extends MessageComposer {
    private final Room room;

    public FlatControllersMessageComposer(Room room) {
        this.room = room;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.FlatControllersMessageComposer);
