...
public class AchievementMessageComposer extends MessageComposer {
    private final Habbo habbo;
    private final Achievement achievement;

    public AchievementMessageComposer(Habbo habbo, Achievement achievement) {
        this.habbo = habbo;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.AchievementMessageComposer);
