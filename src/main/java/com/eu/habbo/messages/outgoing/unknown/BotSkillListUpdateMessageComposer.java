...
public class BotSkillListUpdateMessageComposer extends MessageComposer {
    private final int unknownInt1;
    private final Map<Integer, String> unknownMap;

    public BotSkillListUpdateMessageComposer(int unknownInt1, Map<Integer, String> unknownMap) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.BotSkillListUpdateMessageComposer);
