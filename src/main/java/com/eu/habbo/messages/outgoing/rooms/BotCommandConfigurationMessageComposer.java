...
public class BotCommandConfigurationMessageComposer extends MessageComposer {
    private final Bot bot;
    private final int settingId;

    public BotCommandConfigurationMessageComposer(Bot bot, int settingId) {
        this.bot = bot;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.BotCommandConfigurationMessageComposer);
