...
public class PollContentsMessageComposer extends MessageComposer {
    private final Poll poll;

    public PollContentsMessageComposer(Poll poll) {
        this.poll = poll;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.PollContentsMessageComposer);
