...
public class BotErrorMessageComposer extends MessageComposer {
    ...
    public BotErrorMessageComposer(int errorCode) {
        this.errorCode = errorCode;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.BotErrorMessageComposer);
