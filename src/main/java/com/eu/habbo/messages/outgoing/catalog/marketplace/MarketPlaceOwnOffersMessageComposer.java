...
public class MarketPlaceOwnOffersMessageComposer extends MessageComposer {
    private static final Logger LOGGER = LoggerFactory.getLogger(MarketPlaceOwnOffersMessageComposer.class);

    private final Habbo habbo;

    public MarketPlaceOwnOffersMessageComposer(Habbo habbo) {
        this.habbo = habbo;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.MarketPlaceOwnOffersMessageComposer);
