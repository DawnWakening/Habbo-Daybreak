...
public class RoomSettingsSaveErrorMessageComposer extends MessageComposer {
    ...
    public RoomSettingsSaveErrorMessageComposer(int roomId, int errorCode, String info) {
        this.roomId = roomId;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.RoomSettingsSaveErrorMessageComposer);
