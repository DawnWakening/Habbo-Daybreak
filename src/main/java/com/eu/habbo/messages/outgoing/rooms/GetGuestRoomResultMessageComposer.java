...
public class GetGuestRoomResultMessageComposer extends MessageComposer {
    ...
    public GetGuestRoomResultMessageComposer(Room room, Habbo habbo, boolean roomForward, boolean enterRoom) {
        this.room = room;
        this.habbo = habbo;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.GetGuestRoomResultMessageComposer);
