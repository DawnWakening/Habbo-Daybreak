...
public class SanctionStatusMessageComposer extends MessageComposer {

    private final Habbo habbo;

    public SanctionStatusMessageComposer(Habbo habbo) {
        this.habbo = habbo;
    }
        ...
        if (Emulator.getConfig().getBoolean("hotel.sanctions.enabled")) {
            ...
            if (modToolSanctionItems != null && modToolSanctionItems.size() > 0) {
                ...
                if (item.probationTimestamp > 0) {
                    ...
                    this.response.init(Outgoing.SanctionStatusMessageComposer);
