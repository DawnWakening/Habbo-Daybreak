...
public class UserUpdateMessageComposer extends MessageComposer {
    ...
    public UserUpdateMessageComposer(RoomUnit roomUnit) {
        this.roomUnits = new THashSet<>();
        this.roomUnits.add(roomUnit);
    }

    public UserUpdateMessageComposer(RoomUnit roomUnit, double overrideZ) {
        this(roomUnit);
        this.overrideZ = overrideZ;
    }

    public UserUpdateMessageComposer(THashSet<RoomUnit> roomUnits, boolean value) {
        this.roomUnits = roomUnits;
    }

    public UserUpdateMessageComposer(Collection<Habbo> habbos) {
        this.habbos = habbos;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.UserUpdateMessageComposer);
