...
public class TalentLevelUpMessageComposer extends MessageComposer {
    ...
    public TalentLevelUpMessageComposer(TalentTrackType talentTrackType, TalentTrackLevel talentTrackLevel) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.TalentLevelUpMessageComposer);
