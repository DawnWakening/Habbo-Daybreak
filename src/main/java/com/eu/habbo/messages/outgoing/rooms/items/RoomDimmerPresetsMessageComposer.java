...
public class RoomDimmerPresetsMessageComposer extends MessageComposer {
    private final TIntObjectMap<RoomMoodlightData> moodLightData;

    public RoomDimmerPresetsMessageComposer(TIntObjectMap<RoomMoodlightData> moodLightData) {
