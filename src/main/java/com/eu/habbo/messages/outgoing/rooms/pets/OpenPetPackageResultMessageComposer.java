...
public class OpenPetPackageResultMessageComposer extends MessageComposer {
    ...
    public OpenPetPackageResultMessageComposer(int itemId, int errorCode, String errorString) {
        this.itemId = itemId;
