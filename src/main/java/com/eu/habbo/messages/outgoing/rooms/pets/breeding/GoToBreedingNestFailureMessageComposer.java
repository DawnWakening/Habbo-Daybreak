...
public class GoToBreedingNestFailureMessageComposer extends MessageComposer {
    ...
    public GoToBreedingNestFailureMessageComposer(int reason) {
        this.reason = reason;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.GoToBreedingNestFailureMessageComposer);
