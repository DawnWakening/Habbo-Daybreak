...
public class ConfirmBreedingRequestMessageComposer extends MessageComposer {
    private final int boxId;
    private final int petType;
    private final PetBreedingPet petOne;
    private final PetBreedingPet petTwo;

    public ConfirmBreedingRequestMessageComposer(int boxId, int petType, Pet petOne, String ownerPetOne, Pet petTwo, String ownerPetTwo) {
        this.boxId = boxId;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.ConfirmBreedingRequestMessageComposer);
