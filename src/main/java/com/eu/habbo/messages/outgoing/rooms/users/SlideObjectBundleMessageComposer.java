...
public class SlideObjectBundleMessageComposer extends MessageComposer {
    private static final Logger LOGGER = LoggerFactory.getLogger(SlideObjectBundleMessageComposer.class);
    ...
    public SlideObjectBundleMessageComposer(RoomUnit roomUnit, HabboItem roller, RoomTile oldLocation, double oldZ, RoomTile newLocation, double newZ, Room room) {
    ...
    public SlideObjectBundleMessageComposer(RoomUnit roomUnit, RoomTile newLocation, Room room) {
        this.roomUnit = roomUnit;
        this.roller = null;
