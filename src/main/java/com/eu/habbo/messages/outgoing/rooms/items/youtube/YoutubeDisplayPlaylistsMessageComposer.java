...
public class YoutubeDisplayPlaylistsMessageComposer extends MessageComposer {
    ...
    public YoutubeDisplayPlaylistsMessageComposer(int itemId, ArrayList<YoutubeManager.YoutubePlaylist> playlists, YoutubeManager.YoutubePlaylist currentPlaylist) {
        this.itemId = itemId;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.YoutubeDisplayPlaylistsMessageComposer);
