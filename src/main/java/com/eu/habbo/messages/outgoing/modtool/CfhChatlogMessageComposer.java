...
public class CfhChatlogMessageComposer extends MessageComposer {
    ...
    public CfhChatlogMessageComposer(ModToolIssue issue, List<ModToolChatLog> chatlog, String roomName) {
        this.issue = issue;
        this.chatlog = chatlog;
        this.roomName = roomName;
    }

    public CfhChatlogMessageComposer(ModToolIssue issue, List<ModToolChatLog> chatlog, String roomName, ModToolIssueChatlogType type) {
        this.issue = issue;
        this.chatlog = chatlog;
        this.roomName = roomName;
        this.type = type;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.CfhChatlogMessageComposer);
