...
public class BannedUsersFromRoomMessageComposer extends MessageComposer {
    private final Room room;

    public BannedUsersFromRoomMessageComposer(Room room) {
        this.room = room;
    }
    ...
    protected ServerMessage composeInternal() {
        ...
        this.response.init(Outgoing.BannedUsersFromRoomMessageComposer);
