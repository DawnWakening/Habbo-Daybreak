...
public class UserFlatCatsMessageComposer extends MessageComposer {
    private final List<RoomCategory> categories;

    public UserFlatCatsMessageComposer(List<RoomCategory> categories) {
        this.categories = categories;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.UserFlatCatsMessageComposer);
