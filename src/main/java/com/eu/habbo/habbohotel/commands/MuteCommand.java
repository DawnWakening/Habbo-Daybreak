    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        if (habbo == null) {
            ...
            if (habbo.getHabboInfo().getCurrentRoom() != null) {
                habbo.getHabboInfo().getCurrentRoom().sendComposer(new IgnoreResultMessageComposer(habbo, IgnoreResultMessageComposer.MUTED).compose()); //: IgnoreResultMessageComposer.UNIGNORED
            }
