...
public class HopperActionOne implements Runnable {
    ...
    public void run() {
        ...
        this.room.scheduledComposers.add(new UserUpdateMessageComposer(this.client.getHabbo().getRoomUnit()).compose());
        ...
        Emulator.getThreading().run(() -> {
            ...
            HopperActionOne.this.room.sendComposer(new UserUpdateMessageComposer(HopperActionOne.this.client.getHabbo().getRoomUnit()).compose());
        }, 750);
